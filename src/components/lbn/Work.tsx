    ...
    <section id="work" className="py-24 md:py-32" ref={ref}>
      <div className="container">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item, i) => (
            <article key={item.name} className="reveal group relative glass-strong rounded-3xl overflow-hidden hover:shadow-glow transition-all hover:-translate-y-1">
              ...
              <div className="p-7">
                ...
                <h3 className="font-display font-bold text-2xl mb-2">{item.name}</h3>
